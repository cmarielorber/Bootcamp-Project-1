...
fetch(`https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?categories=breweries&location=${city}`, requestOptions)
  .then(response => response.json())
  .then(result => {
    SDfetchRequest = result;
